...
def analyze_fragments_hdbscan(
    ...
    if reduced_drug.size > 0:
        ...
        drug_labels = hdbscan_clustering(reduced_drug, min_cluster_size=min_cluster_size, metric='jaccard')
    ...
    if reduced_non_drug.size > 0:
        ...
        non_drug_labels = hdbscan_clustering(reduced_non_drug, min_cluster_size=min_cluster_size, metric='jaccard')
...
if __name__ == "__main__":
    ...
    errors = analyze_fragments_hdbscan(
        ...
        pca_components=50,                # Numero di componenti per PCA
